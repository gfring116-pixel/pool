...
class MemberSelectView(discord.ui.View):
    ...
    async def select_member_button(self, interaction: discord.Interaction, button: discord.ui.Button):
...
class ConfirmationView(discord.ui.View):
    def __init__(self, author_id, member, regiment_name, roblox_username, timeout=300):
        super().__init__(timeout=timeout)
        self.author_id = author_id
        self.member = member
        self.regiment_name = regiment_name
